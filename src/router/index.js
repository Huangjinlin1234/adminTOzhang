  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "dutyPage",
        component: () =>
          import("@/views/pages/console/system/sDutyPageInfo/index"),
        meta: { title: "岗位管理" },
        name: "dutyPage",
        children: []
      },
      {
        path: "muban1",
        component: () => import("@/views/templates/first"),
        meta: { title: "muban1" },
        name: "muban1",
        children: []
      },
      {
        path: "muban2",
        component: () => import("@/views/templates/twice"),
        meta: { title: "muban2" },
        name: "muban2",
        children: []
      },
      {
        path: "muban3",
        component: () => import("@/views/templates/third"),
        meta: { title: "muban3" },
        name: "muban3",
        children: []
      }
