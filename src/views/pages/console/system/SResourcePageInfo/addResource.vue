...
export default {
  ...
  data () {
    return {
      loading: false,
      formFields: [
        { label: '上级资源代码', prop: 'rescParentCode', disabled: true },
        { label: '上级资源中文描述', prop: 'rescParentDesc', disabled: true },
        { label: '资源代码', prop: 'rescCode', rules: [{ required: true, message: '资源代码是必填项', trigger: 'blur' }, { max: 32, message: '最大长度为32' }] },
